...
export const BannerPlaystationGameTwo = (props: BannerXboxTwoProps) => {
	const { className } = props

	return (
		<div
			className={cn(
				'flex xl_2:flex lg:min-h-[480px] lg:w-1/2 xl_2:w-[380px] lg:pl-5 lg:pb-12 relative overflow-hidden flex-col gap-2 px-4 py-5 md:py-8 md: rounded-xl_1  outline outline-1 outline-white bg-[url("/images/playstation-game/playstation-gift-bg-mobile.jpg")] lg:bg-[url("/images/playstation-game/playstation-gift-bg.jpg")] bg-cover bg-no-repeat bg-center',
				className
			)}
		>
