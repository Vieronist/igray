  ...
  return (
    <div className="mb-[100px] flex justify-between">
      <div className="w-[650px]" >
        <h3 className="text-[32px] font-extrabold mb-[23px] leading-[35.2px] mt-5">Страница, которую Вы ищете, не может быть найдена</h3>
        <p className="text-[18px] font-normal mb-[32px]">
      ...
      <Image className="hidden xl:block" src={"404.svg"}  alt="404" width={500} height={500}/>
    </div>
  );
};
