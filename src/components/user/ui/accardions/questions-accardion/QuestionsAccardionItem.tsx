...
import styles from './QuestionsAccardion.module.css'

interface QuestionsAccardionItemProps {
	title: string
	content: string
}

export const QuestionsAccardionItem = (props: QuestionsAccardionItemProps) => {
