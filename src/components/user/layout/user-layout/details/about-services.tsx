	...
	return (
		<>
			<Link
				...
				className="block h-[230px] sm:h-[280px] bg-[url('/about-service-mobile.png')] md:bg-[url('/video-bg.png')] bg-no-repeat bg-cover bg-center relative rounded-[100px] w-[95%] sm:w-[80%] md:w-[60%] mx-auto lg:w-[50%]"
			>
