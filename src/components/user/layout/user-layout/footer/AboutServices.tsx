...
export const AboutService = () => {
	return (
		<>
			<Link
				href={
					'http://www.youtube.com/@%D0%98%D0%B3%D1%80%D0%B0%D0%B924'
				}
				className="block h-[230px] sm:h-[280px] bg-[url('/images/about-service-mobile.png')] md:bg-[url('/images/video-bg.png')] bg-no-repeat bg-cover bg-center relative rounded-[34px] lg:rounded-[50px] w-full"
			>
