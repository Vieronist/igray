	...
	return (
		<>
			<Link
				...
				className="block h-[230px] sm:h-[280px] bg-[url('/about-service-mobile.png')] md:bg-[url('/video-bg.png')] bg-no-repeat bg-cover bg-center relative rounded-[34px] lg:rounded-[50px] w-full"
			>
