import { MarketplacesList } from "../market-place/market-plase-list";
import { Contacts } from "./contacts";

export const ContactsPanel = () => {
	return (
		<section className='mb-[50px] xl:mb-[120px] max-w-[1150px] mx-auto'>
			<h3 className='font-extrabold text-[36px] sm:text-[46px] text-center xl:text-left mb-[27px] text-gray-800'>
				Наши контакты
			</h3>
